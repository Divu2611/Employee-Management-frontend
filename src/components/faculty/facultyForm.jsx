...
class FacultyForm extends Form {
    ...
    doSubmit = async () => {
        ...
        const { name, gender, dateOfBirth, office, city, state, country, email, phone, degree, institute, year, designation, department, researchArea } = this.state.data;

        const designations = designation.split(",");
        const departments = department.split(",");
        const researchAreas = researchArea.split(",");
    ...
    async componentDidMount() {
        if (this.employeeId) {
            ...
            const { data: currentEmployeeType } = await faculty.getFaculty(this.employeeId);
            ...
            let { designation, department, researchArea } = currentEmployeeType;

            designation = designation.toString();
            department = department.toString();
            researchArea = researchArea.toString();
